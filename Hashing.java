...
public class App {
    public static void main(String[] args) throws Exception {
        /*
        100 tane anahtar değeri (5 basamaklı) (veri) rasgele üretip bu değerleri boyutu 100 
        ...
        hash fonksiyonu divison (mod alma) olarak kullanılmaktadır.
        */
        ...
        int sayac=0; //100 rasgele anahtar üretimiyle ilgili sayaç
        ...
        while(sayac < dizi_boyut){
            ...
            Random r=new Random();
            key=10000 + r.nextInt(90000);  //5 basamaklı sayı üretimi: 10000-99999 aralığında üretim- bu tabloya eklenecek değer
            index = key % dizi_boyut;     //hash fonk uygulanır ve üretilen değerin hash tablosundaki  poziyon bilgisi elde edilir
            ...
            if(hash_table_l [index] < 0){   //tabloda ilgili alan boş ise key o alana yazılır: çakışma yok
             ...
             if(hash_table_q [index] < 0){   //tabloda ilgili alan boş ise key o alana yazılır: çakışma yok
                ...
                System.out.println(index+ "--->"+ k + "....."+((index + k*k) % dizi_boyut));
